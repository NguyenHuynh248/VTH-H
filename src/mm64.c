...
int pte_set_swap(struct pcb_t *caller, addr_t pgn, int swptyp, addr_t swpoff)
{
  ...
  CLRBIT(*pte, PAGING_PTE_PRESENT_MASK); // KHÔNG còn ở RAM
                     ...
                     struct vm_rg_struct *ret_rg)
{
  ...
  // Todo cấp phát frame liên tục ram, đang giả định cấp phát ko quá 1 frame nên dùng tạm alloc_pages_range
